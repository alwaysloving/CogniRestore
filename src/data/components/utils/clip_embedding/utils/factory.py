...
from src.data.components.utils.clip_embedding.utils.model import CLIP, CustomTextCLIP, convert_weights_to_lp, convert_to_custom_text_state_dict,\
...
_MODEL_CONFIG_PATHS = [PosixPath('/root/autodl-fs/CognitionCapturer/model_pretrained/1c2b8495b28150b8a4922ee1c8edee224c284c0c/')]
